  ...
  return (
    <div className="inside-container-large">
      <div className="flex flex-col items-center gap-6 max-md:px-5.5">
        ...
        >
          A collection of what I&apos;ve actually built - from open-source libraries like React Zero-UI to production apps. Each project highlights the tech I
          used and the performance results it delivered.
        </AnimatedElement>
      </div>
    </div>
  )
